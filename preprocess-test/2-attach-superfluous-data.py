...
def preprocess():
    ...
    speeds_df = pd.read_csv("test_final.csv", dtype={"STATION_ID": object, "STATION_ID_2": object, "STATION_ID_3": object, "STATION_ID_4": object})
    ...
    speeds_df = speeds_df[['EVENT_DETAIL','EVENT_TYPE','KEY','DATETIME_UTC','KM','DISTANCE_FROM_POINT','LENGTH_KM','WEEK_DAY',
                          'TIME_INTERVAL','DELTA_TIME_FROM_START','EMERGENCY_LANE','LANES','ROAD_TYPE','TEMPERATURE','MAX_TEMPERATURE',
    ...
    speeds_df.to_csv("test_final_2.csv", index=False)
